              ...
              <Grid container spacing={1} justifyContent="center">
                ...
                <Grid item xs={12}>
                  <Typography variant="body1">
                    Wheather you are developer or designer, Codot serve the need of all - No matter you are novice or expert
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
              ...
              <Grid container spacing={1.5}>
                ...
                <Grid item xs={12}>
                  <Typography variant="body1" color="secondary">
                    Check the live preview of Codot figma design file. Figma file included in Plus and Extended License only.
                  </Typography>
                </Grid>
                <Grid item xs={12}>
          ...
          >
            <MainCard contentSX={{ p: 3, background: theme.palette.primary.lighter }}>
              <Grid container spacing={1.5}>
                ...
                <Grid item xs={12}>
                  <Typography variant="body1" color="secondary">
                    Check the all components of Codot in single place with search feature for easing your development while working.
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Box sx={{ display: 'inline-block' }}>
