...
// assets
import { EnvironmentOutlined, IdcardFilled, LinkOutlined, MailOutlined, PhoneOutlined } from '@ant-design/icons';
        ...
        <Grid container spacing={2.5} sx={{ pl: { xs: 0, sm: 5, md: 6, lg: 10, xl: 12 } }}>
                ...
                <Grid item xs={12}>
                  <Stack direction="row" justifyContent="space-around" alignItems="center">
                    <Stack spacing={0.5} alignItems="center">
                      ...
                      <Typography color="secondary">Refund Amount</Typography>
                    </Stack>
                    ...
                    <Stack spacing={0.5} alignItems="center">
                      ...
                      <Typography color="secondary">Refund Amount Breakup</Typography>
                    </Stack>
                  </Stack>
                  <Divider  />
                  <Stack spacing={0}  direction="column" justifyContent="space-around" alignItems="center" mt={1}>
                      <Typography color="secondary">Bank Account No.</Typography> 
                      <Typography mt={1} mb={0} variant="h5">657657078778074</Typography>
                    </Stack>
                </Grid>
                  ...
                  <ListItem>
                      ...
                      <ListItemSecondaryAction>
                        <Typography align="right">
                          <NumberFormat displayType="text"  mask="_" defaultValue="#07460867" />
                        </Typography>
                      </ListItemSecondaryAction>
                    </ListItem>
                    <ListItem>
          ...
          <Grid item xs={12} sm={7} md={8} lg={9}>
            <Stack spacing={2.5}>
                ...
                <List sx={{ py: 0 }}>
                  <ListItem divider={!matchDownMD}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12} md={6}>
                        <Stack spacing={0.5}>
                          <Typography color="secondary">Airline Name</Typography>
                          <Typography>
                  ...
                  <ListItem divider={!matchDownMD}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12} md={6}>
                        <Stack spacing={0.5}>
                          <Typography color="secondary">PNR No.</Typography>
                          <Typography>
                  ...
                  <ListItem divider={!matchDownMD}>
                    <Grid container spacing={3}>
                      <Grid item xs={12} md={6}>
                        <Stack spacing={0.5}>
                          <Typography color="secondary">TRIP CLASS - ECONOMY</Typography>
                          <Typography>Second Class</Typography>
              ...
              <MainCard title="ONE WAY OR ROUND TRIP ">
                <Typography color="secondary">
                  Hello, I’m {data.fatherName} international Flight with {data.status} <b>One Way Trip , Thank You</b>
                </Typography>
              </MainCard>
            </Stack>
          </Grid>
