...
import { renderFilterTypes, GlobalFilter, SliderColumnFilter } from 'utils/react-table';
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        className: 'cell-center',
        // eslint-disable-next-line
        Cell: ({ value }:any) => <NumberFormat displayType="text" format="+1 (###) ###-####" mask="_" defaultValue={value} />
      },
      {
      ...
      // },
      {
        ...
        Cell: ({ value }: any) => {
          switch (value) {
            case 'Complicated':
              return <Chip color="error" label="Block" size="small" variant="light" />;
            // case 'Relationship':
            //   return <Chip color="success" label="Verified" size="small" variant="light" />;
            // case 'Single':
            default:
              // return <Chip color="info" label="Pending" size="small" variant="light" />;
              return <Chip color="success" label="Unblock" size="small" variant="light" />;
          }
        }
      },
      // {
