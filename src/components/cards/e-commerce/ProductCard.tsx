...
const ProductCard = ({ id, color, name, brand, shortDescription, isStock, image, description, offerPrice, salePrice, rating }: any) => {
                ...
                <Stack direction="row" justifyContent="space-between" alignItems="flex-end">
                  <Stack>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Typography variant="h5">Coins {salePrice}</Typography>
                      {/* {salePrice && (
